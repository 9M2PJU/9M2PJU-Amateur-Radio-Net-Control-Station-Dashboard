...
import { Settings, Construction, Info, Github } from 'lucide-react'
...
export default function SettingsPage() {
    return (
        <div className="min-h-screen bg-slate-950 text-slate-50 selection:bg-emerald-500/30 selection:text-emerald-300">
            ...
            <div className="fixed top-0 left-0 w-full max-w-7xl h-96 bg-violet-500/5 rounded-full blur-[100px] -z-10"></div>
