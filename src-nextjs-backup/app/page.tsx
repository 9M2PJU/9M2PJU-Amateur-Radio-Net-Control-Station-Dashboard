          ...
          <div className="text-center max-w-4xl mx-auto animate-fade-in">
            ...
            <div className="mb-6 relative">
              ...
              <div className="relative inline-flex w-24 h-24 md:w-28 md:h-28 rounded-2xl overflow-hidden shadow-2xl shadow-emerald-500/40 mb-6 animate-float border border-white/20 bg-slate-900">
                {/* Using simple img for now as logo.png needs to be in public */}
                <Image src="/logo.png" alt="9M2PJU NCS Dashboard Logo" width={112} height={112} className="w-full h-full object-cover scale-110" priority />
              </div>
